 ...
 * A simple text field
 */
class XmcontactFormUser extends XoopsFormElementTray
{
    /**
     * Constructor
     *
     ...
     */
    public function __construct($caption, $name, $firstLineEmpty = false, $value = null, $size = 1, $multiple = false)
    {
        /**
        ...
        if ($firstLineEmpty) {
            $select_element->addOption(0, _AM_XMCONTACT_CATEGORY_RESPONSIBLE_EMPTY);
        }
