...
define('_AM_XMCONTACT_REQUEST_EMAIL', 'Courriel');
...
define('_AM_XMCONTACT_REQUEST_SENDEMAIL', 'Courriel envoyé');
...
define('_AM_XMCONTACT_REQUEST_SUREDEL', 'Êtes vous sûr de vouloir supprimer la demande de : %s');
