...
//new version 1.0
define('_MI_XMCONTACT_PREF_HEAD_SIMPLECONTACT', 'Options valides si le module est utilisé sans catégorie de contact (un seul formulaire de contact)');
...
define('_MI_XMCONTACT_PREF_DOSUBJECT', 'Afficher le suject');
