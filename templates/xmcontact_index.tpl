	...
	<div class="row">
		...
		<{if $info_columncat == 1}>
			<div class="col-3 col-md-4 col-lg-3 text-center" style="padding-bottom: 5px; padding-top: 5px;">
				<img class="rounded img-fluid" src="<{$itemcategory.logo}>" alt="<{$itemcategory.title}>">
			</div>
			<div class="col-9 col-md-8 col-lg-9" style="padding-bottom: 5px; padding-top: 5px;">
				<h4 class="mt-0"><{$itemcategory.title}></h4>
				<{$itemcategory.description}>
				<br>
				<a href="index.php?op=form&cat_id=<{$itemcategory.id}>">
